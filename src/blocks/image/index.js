...
registerBlockType(
	'gt-blocks-pro/image',
	{
		title: __( 'GT Image', 'gt-blocks-pro' ),

		description: __( 'Insert a single image.', 'gt-blocks-pro' ),
		...
		styles: [
			{ name: 'default', label: __( 'Squared', 'gt-blocks-pro' ), isDefault: true },
			{ name: 'rounded', label: __( 'Rounded Corners', 'gt-blocks-pro' ) },
			{ name: 'circle', label: __( 'Circle', 'gt-blocks-pro' ) },
		],
