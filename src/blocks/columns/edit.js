...
const twoColumnLayouts = [
	{ value: '50-50', label: __( '50% | 50%', 'gt-blocks-pro' ) },
	{ value: '60-40', label: __( '60% | 40%', 'gt-blocks-pro' ) },
	{ value: '40-60', label: __( '40% | 60%', 'gt-blocks-pro' ) },
	{ value: '66-33', label: __( '66% | 33%', 'gt-blocks-pro' ) },
	{ value: '33-66', label: __( '33% | 66%', 'gt-blocks-pro' ) },
	{ value: '75-25', label: __( '75% | 25%', 'gt-blocks-pro' ) },
	{ value: '25-75', label: __( '25% | 75%', 'gt-blocks-pro' ) },
];

/* Three Column Layouts */
const threeColumnLayouts = [
	{ value: '33-33-33', label: __( '33% | 33% | 33%', 'gt-blocks-pro' ) },
	{ value: '30-40-30', label: __( '30% | 40% | 30%', 'gt-blocks-pro' ) },
	{ value: '20-60-20', label: __( '20% | 60% | 20%', 'gt-blocks-pro' ) },
	{ value: '50-25-25', label: __( '50% | 25% | 25%', 'gt-blocks-pro' ) },
	{ value: '25-50-25', label: __( '25% | 50% | 25%', 'gt-blocks-pro' ) },
	{ value: '25-25-50', label: __( '25% | 25% | 50%', 'gt-blocks-pro' ) },
];

/* Three Column Layouts */
const fourColumnLayouts = [
	{ value: '25-25-25-25', label: __( '25% | 25% | 25% | 25%', 'gt-blocks-pro' ) },
	{ value: '40-20-20-20', label: __( '40% | 20% | 20% | 20%', 'gt-blocks-pro' ) },
	{ value: '20-20-20-40', label: __( '20% | 20% | 20% | 40%', 'gt-blocks-pro' ) },
];
...
const getTemplate = memoize( ( number ) => {
	return times( number, () => [ 'gt-blocks-pro/column', {} ] );
} );
...
class ColumnsEdit extends Component {
	...
	addColumn() {
		...
		// Create Block.
		const block = createBlock( 'gt-blocks-pro/column', {} );
		...
		return (
			<Fragment>
				...
				<InspectorControls key="inspector">
					...
					<PanelBody title={ __( 'Layout Settings', 'gt-blocks-pro' ) } className="gt-panel-layout-settings gt-panel">

						<BaseControl label={ __( 'Two Columns', 'gt-blocks-pro' ) } className="gt-column-layout-control">
						...
						<BaseControl label={ __( 'Three Columns', 'gt-blocks-pro' ) } className="gt-column-layout-control">
						...
						<BaseControl label={ __( 'Four Columns', 'gt-blocks-pro' ) } className="gt-column-layout-control">
				...
				<div className={ className }>
					...
					<div className={ columnClasses }>
						...
						<InnerBlocks
							...
							templateLock={ false }
							allowedBlocks={ [ 'gt-blocks-pro/column' ] }
						/>
					...
					{ ( isSelected || isChildBlockSelected ) && (
						...
						>
							...
							{ __( 'Change column layout', 'gt-blocks-pro' ) }
						</Button>
					) }
