...
registerBlockType(
	...
	{
		title: __( 'GT Grid Layout', 'gt-blocks-pro' ),

		description: __( 'Add a block that displays child blocks in a grid layout.', 'gt-blocks-pro' ),
		...
		keywords: [
			...
			__( 'Multiple', 'gt-blocks-pro' ),
			__( 'Columns', 'gt-blocks-pro' ),
		],
