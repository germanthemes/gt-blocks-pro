...
registerBlockType(
	...
	{
		title: __( 'GT Button', 'gt-blocks-pro' ),

		description: __( 'Add a button and style it.', 'gt-blocks-pro' ),
		...
		keywords: [
			__( 'Link', 'gt-blocks-pro' ),
			__( 'Call to Action', 'gt-blocks-pro' ),
			__( 'German Themes', 'gt-blocks-pro' ),
		],
		...
		styles: [
			{ name: 'default', label: __( 'Default', 'gt-blocks-pro' ), isDefault: true },
			{ name: 'ghost-button', label: __( 'Ghost Button', 'gt-blocks-pro' ) },
		],
