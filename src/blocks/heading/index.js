...
registerBlockType(
	...
	{
		title: __( 'GT Heading', 'gt-blocks-pro' ),

		description: __( 'Add a headline and style it.', 'gt-blocks-pro' ),
		...
		keywords: [
			__( 'Title', 'gt-blocks-pro' ),
			__( 'Subheading', 'gt-blocks-pro' ),
			__( 'Subtitle', 'gt-blocks-pro' ),
		],
			...
			from: [
				{
					...
					transform: ( { content } ) => {
						return createBlock( 'gt-blocks-pro/heading', {
							title: content,
						} );
					},
				},
