...
registerBlockType(
	...
	{
		title: __( 'GT Portfolio', 'gt-blocks-pro' ),

		description: __( 'Add a block that displays your projects or services in a grid layout.', 'gt-blocks-pro' ),
		...
		keywords: [
			...
			__( 'Image', 'gt-blocks-pro' ),
			__( 'Grid', 'gt-blocks-pro' ),
		],
