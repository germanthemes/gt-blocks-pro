 ...
 */
registerBlockType(
	'gt-blocks-pro/hero-image',
	{
		title: __( 'GT Hero Image', 'gt-blocks-pro' ),

		description: __( 'Add a block with an eye catching headline and call to action buttons.', 'gt-blocks-pro' ),
		...
		keywords: [
			...
			__( 'Hero Image', 'gt-blocks-pro' ),
			__( 'Text', 'gt-blocks-pro' ),
		],
