			...
			return (
				<Fragment>
					...
					<InspectorAdvancedControls>
						...
						<ToggleControl
							label={ __( 'Remove bottom margin?', 'gt-blocks-pro' ) }
...
addFilter( 'editor.BlockEdit', 'gt-blocks-pro/plugins/margin-bottom', withInspectorControl );
...
addFilter( 'blocks.registerBlockType', 'gt-blocks-pro/attributes/margin-bottom', addAttribute );
...
addFilter( 'blocks.getSaveContent.extraProps', 'gt-blocks-pro/save-props/margin-bottom', addSaveProps );
