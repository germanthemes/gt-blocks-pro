		...
		return (
			<Fragment>
				...
				<InspectorControls key="inspector">
					...
					<PanelBody title={ __( 'Layout Settings', 'gt-blocks-pro' ) } initialOpen={ true } className="gt-layout-settings-panel gt-panel">

						<SelectControl
							label={ __( 'Padding', 'gt-blocks-pro' ) }
							value={ padding }
							onChange={ ( newPadding ) => setAttributes( { padding: newPadding } ) }
							options={ [
								{ value: 'none', label: __( 'None', 'gt-blocks-pro' ) },
								{ value: 'small', label: __( 'Small', 'gt-blocks-pro' ) },
								{ value: 'default', label: __( 'Automatic', 'gt-blocks-pro' ) },
						...
						<ToggleControl
							label={ __( 'Remove padding of first block?', 'gt-blocks-pro' ) }
