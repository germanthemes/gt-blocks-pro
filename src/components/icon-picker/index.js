				...
				{ ! icon ? (
					...
					<Fragment>
						<Placeholder
							...
							instructions={ __( 'Choose an icon here.', 'gt-blocks-pro' ) }
							icon="info"
							label={ __( 'Icon', 'gt-blocks-pro' ) }
						>
							<Button isLarge onClick={ this.openModal }>
								{ __( 'Select icon', 'gt-blocks-pro' ) }
							</Button>
						</Placeholder>
					...
					<Fragment>
						...
						{ isSelected ? (
							...
							<Button className="gt-show-icon-picker" onClick={ this.openModal }>
								<Tooltip text={ __( 'Edit icon', 'gt-blocks-pro' ) }>
		...
		return (
			<Fragment>
				...
				{ this.state.isModalActive && (
					<Modal
						className="gt-blocks-pro-icon-picker-modal"
						title={ title }
						closeLabel={ __( 'Close', 'gt-blocks-pro' ) }
						onRequestClose={ this.closeModal }
						focusOnMount={ false }
					>
						<PlainText
							className="gt-icon-picker-search"
							placeholder={ __( 'Search for icon', 'gt-blocks-pro' ) }
...
export default compose( [
	withSelect( ( select ) => {
		const pluginURL = select( 'gt-blocks-pro-store' ).getPluginURL();
