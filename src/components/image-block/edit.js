...
class ImageBlockEdit extends Component {
	...
	getLinkDestinationOptions() {
		return [
			{ value: LINK_DESTINATION_NONE, label: __( 'None', 'gt-blocks-pro' ) },
			{ value: LINK_DESTINATION_MEDIA, label: __( 'Media File', 'gt-blocks-pro' ) },
			{ value: LINK_DESTINATION_ATTACHMENT, label: __( 'Attachment Page', 'gt-blocks-pro' ) },
			{ value: LINK_DESTINATION_CUSTOM, label: __( 'Custom URL', 'gt-blocks-pro' ) },
		];
	}
		...
		return (
			<Fragment>
						...
						<MediaUpload
							...
							render={ ( { open } ) => (
								<IconButton
									...
									label={ __( 'Edit image', 'gt-blocks-pro' ) }
									icon="edit"
									onClick={ open }
								/>
							) }
				...
				<InspectorControls>
					...
					<PanelBody title={ __( 'Image Settings', 'gt-blocks-pro' ) } initialOpen={ isPanelOpen } className="gt-panel-image-settings gt-panel">

						<TextareaControl
							label={ __( 'Alt Text (Alternative Text)', 'gt-blocks-pro' ) }
							value={ alt }
							onChange={ ( newAlt ) => setAttributes( { alt: newAlt } ) }
							help={ __( 'Describe the purpose of the image. Leave empty if the image is not a key part of the content.', 'gt-blocks-pro' ) }
						/>

						{ ! isEmpty( availableSizes ) && (
							<SelectControl
								label={ __( 'Image Size', 'gt-blocks-pro' ) }
								value={ size }
						...
						<SelectControl
							label={ __( 'Maximum Width', 'gt-blocks-pro' ) }
							value={ maxWidth }
							onChange={ ( newWidth ) => setAttributes( { maxWidth: newWidth } ) }
							options={ [
								{ value: '100', label: __( '100%', 'gt-blocks-pro' ) },
								{ value: '85', label: __( '85%', 'gt-blocks-pro' ) },
								{ value: '75', label: __( '75%', 'gt-blocks-pro' ) },
								{ value: '60', label: __( '60%', 'gt-blocks-pro' ) },
								{ value: '50', label: __( '50%', 'gt-blocks-pro' ) },
								{ value: '40', label: __( '40%', 'gt-blocks-pro' ) },
								{ value: '25', label: __( '25%', 'gt-blocks-pro' ) },
							] }
						/>

					</PanelBody>

					<PanelBody title={ __( 'Link Settings', 'gt-blocks-pro' ) } initialOpen={ false } className="gt-panel-link-settings gt-panel">

						<SelectControl
							label={ __( 'Link To', 'gt-blocks-pro' ) }
						...
						{ linkDestination !== LINK_DESTINATION_NONE && (
							<TextControl
								label={ __( 'Link URL', 'gt-blocks-pro' ) }
								value={ href || '' }
